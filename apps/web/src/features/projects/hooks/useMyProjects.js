...
import { getMyProjects } from "../projectsService";
import { Alerts } from "@/shared/alerts";
import { getDisplayMessage, AuthenticationError } from "@/utils/errorHandler";

/**
 * Hook para obtener los proyectos aprobados del usuario autenticado
 * @param {number} initialPage - Página inicial (default: 1)
 * @returns {Object} { projects, pagination, isLoading, error, handlePageChange, refreshProjects }
 */
export default function useMyProjects(initialPage = 1) {
  ...
  /**
   * Refresca la lista de proyectos (útil después de crear/eliminar)
   */
