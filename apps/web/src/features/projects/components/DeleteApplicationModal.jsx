        ...
        <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-red-700 dark:text-red-400 space-y-1 list-disc list-inside">
                  ...
                  <li>Ya no aparecerá en "Mis Solicitudes"</li>
                  <li>No estará disponible en "Explorar Proyectos"</li>
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
              <span className="font-semibold">Solicitud:</span> {application?.title || 'Sin título'}
            </p>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              <span className="font-semibold">Estado actual:</span> {application?.status?.name || 'Desconocido'}
            </p>
          </div>
